...
create_data = {
    ...
    "title": 'python_test_app',  # Title: qvs 的名称，可选，注意，Title 不是唯一标识，重复 create 动作将生成多个 qvs。
    ...
    # 即同一个身份的 client (qvs/room/user) ，新的连麦请求可以成功，旧连接被关闭。
}
...
update_data = {
    ...
    "title": "python_new_app",  # Title: qvs 的名称， 可选。
    # "maxUsers": <MaxUsers>,                       # MaxUsers: int 类型，可选，连麦房间支持的最大在线人数。
...
roomAccess = {
    "appId": "<AppID>:必填",  # AppID: 房间所属帐号的 qvs 。
